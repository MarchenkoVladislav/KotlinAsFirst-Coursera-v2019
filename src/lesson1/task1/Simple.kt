 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg + min / 60.0 + sec / 3600.0) * (Math.PI / 180)
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int =
    minutesArrive + (hoursArrive - hoursDepart) * 60 - minutesDepart
